...
function transliterateIntoLatin() {
    var textArea = document.getElementById("georgian-text-meta-box");
    var georgianText = textArea.value;
    ...
    document.getElementById("latin-transliteration-meta-box").value = latinText;
}
