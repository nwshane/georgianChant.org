...
= 1.4 =
New: Brute force protection - added security which blocks access to users after repeated failed login attempts. You can choose to automatically grant access to admin users. You can preview the login page even if already logged in.